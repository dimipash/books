        ...
        <section className="flex flex-col lg:flex-row items-center mb-10">
            <div className="text my-5">
                ...
                <Link
                    to="/products"
                    type="button"
                    className="text-white bg-blue-700 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2 focus:outline-none"
                >
                    Explore eBooks
                </Link>
            </div>
